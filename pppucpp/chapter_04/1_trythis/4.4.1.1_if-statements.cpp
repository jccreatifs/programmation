...
// Solution starts here
    ...
    if (currency == 'P'){
        std::cout << amount << " pesos is " << amount / php_per_dollar << " dollars.\n";
    }
    else if (currency == 'Y'){
        std::cout << amount << " yen is " << amount / yen_per_dollar << " dollars.\n"; 
    }
    else if (currency == 'W'){
        std::cout << amount << " won is " << amount / won_per_dollar << " dollars.\n";
    }
    else {
        std::cout << "Sorry, I don't what currency is " << currency << ".\n"; 
    }
